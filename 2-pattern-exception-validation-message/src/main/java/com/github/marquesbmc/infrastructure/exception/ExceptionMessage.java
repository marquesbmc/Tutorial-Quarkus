...
public class ExceptionMessage {
	...
	public Message getClass(Throwable ex) {
	...
	private Status getStatusCode(Throwable exception) {
		
		Status statusCode = null;
				
		 /* if ((exception instanceof javax.ws.rs.BadRequestException)) {
		 ...
		 if ((exception instanceof javax.ws.rs.NotAuthorizedException)) { 
			  ...
			  // TODO : Novas exeções/status code.... 
			  
		  } else { statusCode=Status.BAD_REQUEST;
		  }
